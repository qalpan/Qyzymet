...
function UGTileDesign(){
	...
	var g_options = {
			...
			tile_overlay_color: "#ffffff",			//tile overlay color
...
function UGSlider(){
	...
	function runSlider(){
	   ...
	   if(g_options.slider_background_color){	   		
		   ...
		   bgColor = g_functions.convertHexToRGB("#ffffff", g_options.slider_background_opacity);
		   g_objSlider.css("background-color", bgColor);
	...
	function getLoaderClass(){
		...
		if(g_options.slider_loader_color == "blue")
...
function UGTextPanel(){
	...
	var g_options = {
			...
			textpanel_bg_color:"",				//textpanel background color
...
function UGLightbox(){
	...
	var g_defaults = {
			...
			lightbox_slider_loader_color: "blur",
